...
void UARTIntHandler(void)
{
	...
	while(UARTCharsAvail(UART0_BASE)) //loop while there are chars
	{
		...
		case 21:
			sendto_Dpot(0,((lp30_R0*256)/100000)-1);
			sendto_Dpot(1,((lp30_R1*256)/100000)-1);
			sendto_Dpot(2,((lp30_R2*256)/100000)-1);
			sendto_Dpot(3,((lp30_R3*256)/100000)-1);
			sendto_Dpot(4,((lp30_R4*256)/100000)-1);
			sendto_Dpot(5,((lp30_R5*256)/100000)-1);
			sendto_Dpot(6,((lp30_R6*256)/100000)-1);
			sendto_Dpot(7,((lp30_R7*256)/100000)-1);
			break;

		case 22:
			sendto_Dpot(0,((lp65_R0*256)/100000)-1);
			sendto_Dpot(1,((lp65_R1*256)/100000)-1);
			sendto_Dpot(2,((lp65_R2*256)/100000)-1);
			sendto_Dpot(3,((lp65_R3*256)/100000)-1);
			sendto_Dpot(4,((lp65_R4*256)/100000)-1);
			sendto_Dpot(5,((lp65_R5*256)/100000)-1);
			sendto_Dpot(6,((lp65_R6*256)/100000)-1);
			sendto_Dpot(7,((lp65_R7*256)/100000)-1);
			break;

		case 23:
			sendto_Dpot(0,((lp100_R0*256)/100000)-1);
			sendto_Dpot(1,((lp100_R1*256)/100000)-1);
			sendto_Dpot(2,((lp100_R2*256)/100000)-1);
			sendto_Dpot(3,((lp100_R3*256)/100000)-1);
			sendto_Dpot(4,((lp100_R4*256)/100000)-1);
			sendto_Dpot(5,((lp100_R5*256)/100000)-1);
			sendto_Dpot(6,((lp100_R6*256)/100000)-1);
			sendto_Dpot(7,((lp100_R7*256)/100000)-1);
			break;
