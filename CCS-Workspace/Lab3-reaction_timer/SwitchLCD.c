...
* Experiment-3
*
* 	Reaction Timer With LCD Interfacing
*
...
// Globals
//---------------------------------------
volatile int8_t time_counter = 0;
...
void main(void)
{
    uint16_t attempt,average_response;
...
// * * * * * * * * * * * *  LCD_Functions* * * * * * * * *
void lcd_set_RS(){GPIOPinWrite(GPIO_PORTA_BASE,(GPIO_PIN_2),0x01<<2);}
void lcd_set_RW(){	GPIOPinWrite(GPIO_PORTA_BASE,(GPIO_PIN_3),0x01<<3); }
void lcd_set_EN(){	GPIOPinWrite(GPIO_PORTA_BASE,(GPIO_PIN_4),0x01<<4); }
void lcd_reset_RS(){ GPIOPinWrite(GPIO_PORTA_BASE,(GPIO_PIN_2),~(0x01<<2));}
void lcd_reset_RW(){ GPIOPinWrite(GPIO_PORTA_BASE,(GPIO_PIN_3),~(0x01<<3));}
void lcd_reset_EN(){ GPIOPinWrite(GPIO_PORTA_BASE,(GPIO_PIN_4),~(0x01<<4));}
